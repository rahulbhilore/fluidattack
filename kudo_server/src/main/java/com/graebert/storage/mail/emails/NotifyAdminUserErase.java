...
public class NotifyAdminUserErase {
  public static final EmailTemplateType EMAIL_TEMPLATE_TYPE =
      EmailTemplateType.NOTIFYADMINUSERERASE;

  public static JsonObject getEmailData(String proName, String locale, Item admin, String userId) {
    try {
      Item user = null;
      ...
      if (admin != null && user != null) {
        ...
        String title = Utils.getLocalizedString(locale, "UserAccountErased");
        scopes.put("Title", title);
        scopes.put("UserAccountErased", title);
        scopes.put(
            "Username",
