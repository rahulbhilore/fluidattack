...
// This email actually will be received for enable and disable
public class AccountEnabledEmail {
  public static final EmailTemplateType EMAIL_TEMPLATE_TYPE = EmailTemplateType.ACCOUNTENABLED;

  public static JsonObject getEmailData(
      String proName, String locale, String userId, boolean isEnabled) {
    try {
      Item user = null;
      ...
      if (user != null) {
        ...
        scopes.put(
            ...
            Utils.getLocalizedString(
                locale,
                isEnabled
                    ? "YourAccountIsEnabled"
                    : "YourAccountIsDisabled" + Utils.getStringPostfix(proName)));
