...
public class ExternalAccounts extends Dataplane {
  ...
  public static void updateUserAccountType(String userId, String externalId, String accountType) {
    updateExternalAccount(
        userId,
        externalId,
        "set #at = :atVal",
        new NameMap().with("#at", "accountType"),
        new ValueMap().withString(":atVal", accountType));
  }
