...
public class EncryptHelper {
  ...
  static {
    try {
      asymmetricCiper = Cipher.getInstance("RSA"); // FA: REPLACE
    } catch (Exception ex) {
      ex.printStackTrace();
    }
  }
  ...
  public static String md5Hex(@NonNls String secret) {
    return DigestUtils.md5Hex(secret); // FA: REPLACE!
  }

  public static String encodePassword(String passwordToEncode)
      throws IOException, NoSuchAlgorithmException {
    return DigestUtils.sha3_256Hex(passwordToEncode);
  }
  ...
  public static String encrypt(String str, String key)
    ...
    Cipher ecipher = Cipher.getInstance("DES"); // FA: REPLACE!
  ...
  public static String decrypt(String str, String key)
    ...
    SecretKey secretKey = new MySecretKey(key);
    Cipher dcipher = Cipher.getInstance("DES"); // FA: REPLACE!
  ...
  public static String intercomHash(String userid, String intercomAppId)
    ...
    SecretKeySpec secret_key = new SecretKeySpec(secret.getBytes(), "HmacSHA256"); // FA: REPLACE!
