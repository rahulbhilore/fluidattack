...
function log() {
  ...
  const currentLogStamps = [
    "[",
    timestampFormat(moment().format("HH:mm:ss.SSS DD.MM")),
    "]"
  ];
...
function getClientEnvironment(publicUrl) {
  const raw = Object.keys(process.env)
    ...
    .reduce(
      ...
      {
        TEST_ENV: (process.env.TEST_ENV || "").toString().trim(),
  ...
  log("Environmental variables:", JSON.stringify(stringified));
  return { raw, stringified };
}
export { getClientEnvironment, loadEnv };
