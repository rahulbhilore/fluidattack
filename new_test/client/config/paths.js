...
const publicUrlOrPath = getPublicUrlOrPath(
  ...
  // DK: I enforced it as we never actually changed it
  "/",
...
const paths = {
  ...
  appTemplates: resolveApp("public/templates"),
  tsConfig: resolveApp("config/tsconfig.json"),
  eslintConfig: resolveApp("config/.eslintrc"),
  appHTMLTemplate: resolveApp("public/index.pug"),
  dotenv: resolveApp(".env"),
  appPath: resolveApp("."),
  appBuild: resolveApp("build"),
  appPublic: resolveApp("public"),
  appHtml: resolveApp("public/index.html"),
  appIndexJs: resolveModule(resolveApp, "src/src/generic"),
